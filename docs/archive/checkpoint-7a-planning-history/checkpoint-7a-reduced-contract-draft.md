# Draft: Checkpoint 7A — Remote Candidate Inspection

Status: **draft for contract review**. This file narrows 7A; it does not replace
or modify the existing 7A contract or implementation.
...
store; no trusted local endpoint is required by acceptance tests.
...
This draft is for contract review only. No implementation or existing contract
has been deleted, renamed, or rewritten.
